...
namespace Driving_school_managment_system {
    ...
    public partial class DrivingDataSet1 : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public StudentsRow AddStudentsRow(string Name, string Email, string Phone, string Address, System.DateTime DOB) {
...
namespace Driving_school_managment_system.DrivingDataSet1TableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([Name], [Email], [Phone], [Address], [DOB]) VALUES " +
                "(@Name, @Email, @Phone, @Address, @DOB);\r\nSELECT Id, Name, Email, Phone, Address" +
                ", DOB FROM Students WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [Name] = @Name, [Email] = @Email, [Phone] = @Phone, [Address] = @Address, [DOB] = @DOB WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Email] = @Original_Email) AND ([Phone] = @Original_Phone) AND ([Address] = @Original_Address) AND ([DOB] = @Original_DOB));
SELECT Id, Name, Email, Phone, Address, DOB FROM Students WHERE (Id = @Id)";
        ...
        public virtual int Fill(DrivingDataSet1.StudentsDataTable dataTable) {
        ...
        public virtual DrivingDataSet1.StudentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DrivingDataSet1.StudentsDataTable dataTable = new DrivingDataSet1.StudentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DrivingDataSet1.StudentsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Email, string Original_Phone, string Original_Address, System.DateTime Original_DOB) {
        ...
        public virtual int Insert(string Name, string Email, string Phone, string Address, System.DateTime DOB) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Email, string Phone, string Address, System.DateTime DOB, int Original_Id, string Original_Name, string Original_Email, string Original_Phone, string Original_Address, System.DateTime Original_DOB, int Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Email, string Phone, string Address, System.DateTime DOB, int Original_Id, string Original_Name, string Original_Email, string Original_Phone, string Original_Address, System.DateTime Original_DOB) {
            return this.Update(Name, Email, Phone, Address, DOB, Original_Id, Original_Name, Original_Email, Original_Phone, Original_Address, Original_DOB, Original_Id);
        }
    }
