...
namespace Driving_school_managment_system {
    ...
    public partial class DrivingDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public StudentsRow AddStudentsRow(int Id, string Name, string Email, int Phone, string Address, System.DateTime DOB) {
...
namespace Driving_school_managment_system.DrivingDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Students] WHERE (([Id] = @Original_Id) AND ([Name] = @Original" +
                "_Name) AND ([Email] = @Original_Email) AND ([Phone] = @Original_Phone) AND ([Add" +
                "ress] = @Original_Address) AND ([DOB] = @Original_DOB))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([Id], [Name], [Email], [Phone], [Address], [DOB]) V" +
                "ALUES (@Id, @Name, @Email, @Phone, @Address, @DOB);\r\nSELECT Id, Name, Email, Pho" +
                "ne, Address, DOB FROM Students WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [Id] = @Id, [Name] = @Name, [Email] = @Email, [Phone] = @Phone, [Address] = @Address, [DOB] = @DOB WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Email] = @Original_Email) AND ([Phone] = @Original_Phone) AND ([Address] = @Original_Address) AND ([DOB] = @Original_DOB));
SELECT Id, Name, Email, Phone, Address, DOB FROM Students WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Email, Phone, Address, DOB FROM dbo.Students";
        ...
        public virtual int Fill(DrivingDataSet.StudentsDataTable dataTable) {
        ...
        public virtual DrivingDataSet.StudentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DrivingDataSet.StudentsDataTable dataTable = new DrivingDataSet.StudentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DrivingDataSet.StudentsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Email, int Original_Phone, string Original_Address, System.DateTime Original_DOB) {
        ...
        public virtual int Insert(int Id, string Name, string Email, int Phone, string Address, System.DateTime DOB) {
        ...
        public virtual int Update(int Id, string Name, string Email, int Phone, string Address, System.DateTime DOB, int Original_Id, string Original_Name, string Original_Email, int Original_Phone, string Original_Address, System.DateTime Original_DOB) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Email, int Phone, string Address, System.DateTime DOB, int Original_Id, string Original_Name, string Original_Email, int Original_Phone, string Original_Address, System.DateTime Original_DOB) {
            return this.Update(Original_Id, Name, Email, Phone, Address, DOB, Original_Id, Original_Name, Original_Email, Original_Phone, Original_Address, Original_DOB);
        }
    }
